...
export default function Compliance() {
  ...
  return (
    <section id="compliance" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-gray-900 to-gray-800 dark:from-surface-950 dark:to-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12 sm:mb-16">
          {standards.map((standard, index) => (
            <div key={index} className="bg-gray-800/50 dark:bg-gray-800/70 backdrop-blur-sm rounded-xl p-5 sm:p-6 border border-gray-700 dark:border-gray-600 hover:border-brand-500 dark:hover:border-brand-400 transition-all group shadow-soft hover:shadow-card">
              ...
              <p className="text-sm sm:text-base text-gray-300 dark:text-gray-400 leading-relaxed">{standard.description}</p>
            </div>
          ))}
        </div>

        <div className="bg-gradient-to-r from-brand-600/20 to-brand-700/20 dark:from-brand-600/30 dark:to-brand-700/30 rounded-xl p-6 sm:p-8 lg:p-12 border border-brand-500/30 dark:border-brand-400/40 backdrop-blur-sm shadow-card">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div>
              <h3 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Comprehensive Documentation</h3>
              <p className="text-lg sm:text-xl text-gray-300 dark:text-gray-400 mb-4 sm:mb-6 leading-relaxed">
              ...
              <ul className="space-y-2.5 sm:space-y-3">
                <li className="flex items-center text-sm sm:text-base text-gray-300 dark:text-gray-400">
                  <div className="w-2 h-2 bg-brand-400 dark:bg-brand-300 rounded-full mr-3 flex-shrink-0"></div>
            ...
            <div className="text-center mt-6 lg:mt-0">
              <div className="bg-white/10 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 sm:p-8 shadow-soft">
                <FileCheck className="w-16 h-16 sm:w-20 sm:h-20 text-brand-400 dark:text-brand-300 mx-auto mb-3 sm:mb-4" />
