/**
 * SERA - ENHANCED AI DATA SECURITY ASSISTANT
 * 
      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 dark:bg-brand-600 dark:hover:bg-brand-700 text-white p-4 rounded-full shadow-2xl transition-colors z-50"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-6 right-6 w-96 h-[32rem] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-800 flex flex-col z-50"
          >
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 dark:from-brand-600 dark:to-brand-700 text-white p-4 rounded-t-2xl flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <div className="bg-white/20 p-2 rounded-full">
                  <Bot className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="font-semibold">Sera</h3>
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800">
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Ask Sera about data security..."
                className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950 dark:text-white rounded-full focus:ring-2 focus:ring-blue-500 dark:focus:ring-brand-500 focus:border-transparent text-sm"
                disabled={isLoading}
              />
              <button
                onClick={() => sendMessage()}
                disabled={!inputMessage.trim() || isLoading}
                className="bg-blue-600 hover:bg-blue-700 dark:bg-brand-600 dark:hover:bg-brand-700 disabled:bg-gray-300 text-white p-2 rounded-full transition-colors"
              >
